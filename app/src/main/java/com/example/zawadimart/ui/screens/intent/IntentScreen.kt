package com.example.zawadimart.ui.screens.intent
...
fun IntentScreen(navController: NavController){
    ...
    Column (modifier = Modifier.fillMaxSize()){
        ...
        Button(onClick = {
            ...
            callIntent.data="tel:0722918417".toUri()
        ...
        Button(onClick = {
            ...
            smsIntent.data="smsto:0722918417".toUri()
            smsIntent.putExtra("sms_body","Hello Andrew,how was your day?")
        ...
        Button(onClick = {
            ...
            val shareIntent = Intent(Intent.ACTION_SEND)
            shareIntent.type = "text/plain"
            shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("mutumasweekly@gmail.com"))
